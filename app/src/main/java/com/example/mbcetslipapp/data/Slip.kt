...
val slips = mutableListOf(
    Slip(name = R.string.name_1, slipType = R.string.slip_misc, title = "Trials", slipDescribe = "Trial And Error", className = R.string.class_1, semester = 3, advisors = listOf(R.string.advisor_1, R.string.advisor_2, R.string.advisor_3), HoD = R.string.hod_cs, rollNo = R.string.roll_1, status = mutableStateOf(true) ),
    Slip(name = R.string.name_2, slipType = R.string.slip_id, title = "Request for new ID", slipDescribe = "This is to request for a new id. Unfortunately, my ID is lost, and I would like to request a replacement.", semester = 7, className = R.string.class_2, advisors = listOf(R.string.advisor_4, R.string.advisor_3), HoD = R.string.hod_cs, rollNo = R.string.roll_2,status = mutableStateOf(false) ),
    Slip(name = R.string.name_3, slipType = R.string.slip_misc, title = "Trials", slipDescribe = "Trial And Error", semester = 5, className = R.string.class_1, advisors = listOf(R.string.advisor_2), HoD = R.string.hod_cs, rollNo = R.string.roll_3,status = mutableStateOf(false) ),
